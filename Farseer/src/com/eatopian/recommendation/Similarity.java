...
public class Similarity {
    ...
    private double[] getRepresentativeVector(List<String> tagList, Map<String, Integer> map) {
    ...
    private double getVectorProduct(List<String> tag1, List<String> tag2, Map<String, Integer> map) {
        Integer vSize=map.size();
    ...
    private double getSimilarity(Dish dish1, Dish dish2) {
        ...
        similarityIngredient=this.getVectorProduct(dish1.getIngredientTagList(),dish2.getIngredientTagList(),this.IngredientMap);
        similarityTaste=this.getVectorProduct(dish1.getTasteTagList(),dish2.getTasteTagList(),this.TasteMap);
        similarityCooking=this.getVectorProduct(dish1.getCookingTagList(),dish2.getCookingTagList(),this.CookingMap);
        double similarity=similarityTaste*0.5+similarityCooking*0.25+similarityIngredient*0.25;
        return similarity;
    }
    ...
    private void getAllSimilarityForDish(Dish dish1) {
        PriorityQueue<PriorityDish> heap=new PriorityQueue<PriorityDish>(20,new Comparator<PriorityDish>() {
            @Override
